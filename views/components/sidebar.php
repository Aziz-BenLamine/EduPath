...
<body>
  <div class="sidebar" role="navigation" aria-label="Sidebar">
    ...
    <a href="/EduPath/views/BackOffice/dashboard.php"><i class="fas fa-users"></i> Gestion des utilisateurs</a>
    ...
    <a href="/EduPath/quizznourane/sidebar.php"><i class="fas fa-question-circle"></i> Gestion des quizs</a>
    <a href="/EduPath/views/BackOffice/listeRec.php"><i class="fas fa-exclamation-triangle"></i> Gestion des reclamations</a>
    <div class="submenu">
